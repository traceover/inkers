...
execute if predicate inkers:ally_territory run effect give @s saturation 1 0 true
execute if predicate inkers:ally_territory run effect give @s speed 1 15 true
